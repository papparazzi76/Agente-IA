...
const StarIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-tech-cyan" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6.5 8.5l-1.414-1.414M11.5 3.5L10 5m-1.5 3.5l1.414-1.414M12 21a9 9 0 110-18 9 9 0 010 18z" /></svg>;
...
const CategoryCard: React.FC<CategoryCardProps> = ({ icon, titleKey, descKey, items, priceKey }) => {
    const { t } = useLanguage();
    return (
...
const MarketplacePage: React.FC = () => {
    ...
    // FIX: The useScrollAnimation hook is generic. The 'gridRef' is attached to a <div> element,
    // so we must specify HTMLDivElement as the type to avoid a mismatch.
    ...
    const categories: CategoryCardProps[] = [
        { icon: <WebIcon />, titleKey: 'marketplace.cat1Title', descKey: 'marketplace.cat1Desc', items: ['marketplace.cat1Item1', 'marketplace.cat1Item2', 'marketplace.cat1Item3', 'marketplace.cat1Item4'], priceKey: 'marketplace.cat1Price'},
        { icon: <ChipIcon />, titleKey: 'marketplace.cat2Title', descKey: 'marketplace.cat2Desc', items: ['marketplace.cat2Item1', 'marketplace.cat2Item2', 'marketplace.cat2Item3', 'marketplace.cat2Item4'], priceKey: 'marketplace.cat2Price'},
        { icon: <MegaphoneIcon />, titleKey: 'marketplace.cat3Title', descKey: 'marketplace.cat3Desc', items: ['marketplace.cat3Item1', 'marketplace.cat3Item2', 'marketplace.cat3Item3', 'marketplace.cat3Item4'], priceKey: 'marketplace.cat3Price'},
        { icon: <GearsIcon />, titleKey: 'marketplace.cat4Title', descKey: 'marketplace.cat4Desc', items: ['marketplace.cat4Item1', 'marketplace.cat4Item2', 'marketplace.cat4Item3', 'marketplace.cat4Item4'], priceKey: 'marketplace.cat4Price'},
        { icon: <GavelIcon />, titleKey: 'marketplace.cat5Title', descKey: 'marketplace.cat5Desc', items: ['marketplace.cat5Item1', 'marketplace.cat5Item2', 'marketplace.cat5Item3'], priceKey: 'marketplace.cat5Price'},
        { icon: <StarIcon />, titleKey: 'marketplace.cat6Title', descKey: 'marketplace.cat6Desc', items: ['marketplace.cat6Item1', 'marketplace.cat6Item2', 'marketplace.cat6Item3', 'marketplace.cat6Item4'], priceKey: 'marketplace.cat6Price'},
    ];
